...
<body class="bg-gray-100 font-Karla">
    ...
    <nav class="bg-gray-800 text-white w-64 h-full hidden fixed md:flex flex-col justify-between">
        ...
        <div class="p-4">
            <a href="logout.php" class="flex items-center space-x-3 hover:bg-gray-700 p-2 rounded-md">
    ...
    <nav class="bg-gray-800 text-white md:hidden w-full h-content fixed top-0 flex justify-between">
        <div class="p-4 w-full">
            ...
            <div id="menu" class="hidden flex-col gap-y-3 space-y-4">
                ...
                <a href="#logout" class="flex items-center space-x-3 hover:bg-gray-700 p-2 rounded-md pb-5">
                    <i class="fas fa-sign-out-alt fa-lg"></i>
                    <span>Logout</span>
                </a>
            </div>
    ...
    <div class="md:ml-72 md:mt-0 mt-36 w-full md:w-3/4">
        <div class="p-8 w-full flex flex-col space-y-8">
            ...
            <section class="flex flex-wrap gap-4">
                <div class="bg-white p-4 rounded-lg shadow flex flex-wrap items-center w-full md:w-1/2 lg:w-1/4">
                    <div class="flex-1 flex flex-col">
                        <p class="text-gray-500">Title 1</p>
                        <h4 class="text-lg font-bold">Content 1</h4>
                    </div>
                    <div class="w-12 h-12">
                        <img src="https://via.placeholder.com/50" alt="Icon 1" class="w-full h-full object-cover rounded-full">
                    </div>
                </div>
                <div class="bg-white p-4 rounded-lg shadow flex flex-wrap items-center w-full md:w-1/2 lg:w-1/4">
                    <div class="flex-1 flex flex-col">
                        <p class="text-gray-500">Title 2</p>
                        <h4 class="text-lg font-bold">Content 2</h4>
                    </div>
                    <div class="w-12 h-12">
                        <img src="https://via.placeholder.com/50" alt="Icon 2" class="w-full h-full object-cover rounded-full">
                    </div>
                </div>
                <div class="bg-white p-4 rounded-lg shadow flex flex-wrap items-center w-full md:w-1/2 lg:w-1/4">
                    <div class="flex-1 flex flex-col">
                        <p class="text-gray-500">Title 3</p>
                        <h4 class="text-lg font-bold">Content 3</h4>
                    </div>
                    <div class="w-12 h-12">
                        <img src="https://via.placeholder.com/50" alt="Icon 3" class="w-full h-full object-cover rounded-full">
                    </div>
                </div>
                <div class="bg-white p-4 rounded-lg shadow flex flex-wrap items-center w-full md:w-1/2 lg:w-1/4">
                    <div class="flex-1 flex flex-col">
            ...
            <section class="flex flex-col space-y-4">
                ...
                <div class="bg-white p-4 rounded-lg shadow flex flex-col items-start">
                    <h2 class="text-2xl font-bold mb-2">Section 2 Title 2</h2>
                    <p class="text-gray-700 mb-2">This is some descriptive text for the second part of section 2.</p>
                    <p class="text-gray-700">This is more descriptive text for the second part of section 2.</p>
                </div>
                <div class="bg-white p-4 rounded-lg shadow flex flex-col items-start">
                    <h2 class="text-2xl font-bold mb-2">Section 2 Title 3</h2>
                    <p class="text-gray-700 mb-2">This is some descriptive text for the third part of section 2.</p>
                    <p class="text-gray-700">This is more descriptive text for the third part of section 2.</p>
                </div>
            </section>
        </div>
    </div>
        ...
        new Chart(ctx, {
            ...
            datasets: [{
                ...
                data: [
                    ...
                    $incomes = query("SELECT SUM(cost) AS total_cost FROM income WHERE month = 'January'")[0];
